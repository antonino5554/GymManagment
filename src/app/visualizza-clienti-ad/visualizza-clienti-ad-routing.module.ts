...
import { VisualizzaClientiAdPage } from './visualizza-clienti-ad.page'; //permette di mostrare la pagina d'interesse

const routes: Routes = [
  {
    path: '',
    component: VisualizzaClientiAdPage  //mostra la pagina
  }
];
