...
import { AdminHomepagePage } from './admin-homepage.page';         //permette di accedere al componente che vogliamo testare

//definisce un insieme di test per la pagina
describe('AdminHomepagePage', () => {
  let component: AdminHomepagePage;                   //oggetto pagina
  let fixture: ComponentFixture<AdminHomepagePage>;   //serve per testare tutto insieme unendo l'oggetto e HTML

  //eseguito prima di ogni test
  beforeEach(() => {
    fixture = TestBed.createComponent(AdminHomepagePage); //crea il componente da testare in un ambiente isolato
