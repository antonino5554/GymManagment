...
import { VisualizzaAllenamentiPage } from './visualizza-allenamenti.page'; //permette di mostrare la pagina d'interesse

const routes: Routes = [
  {
    path: '',
    component: VisualizzaAllenamentiPage //mostra la pagina
  }
];
